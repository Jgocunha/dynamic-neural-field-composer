...
void util::BlueprintNodeBuilder::Input(ed::PinId id)
{
    ...
    if (applyPadding)
        dnf_composer::user_interface::widgets::Spring(0);

    Pin(id, PinKind::Input);

    dnf_composer::user_interface::widgets::BeginHorizontal(id.AsPointer());
}

void util::BlueprintNodeBuilder::EndInput()
{
    dnf_composer::user_interface::widgets::EndHorizontal();
...
bool util::BlueprintNodeBuilder::SetStage(Stage stage)
{
    ...
    switch (oldStage)
    {
        ...
        case Stage::Header:
            ...
            dnf_composer::user_interface::widgets::Spring(0, ImGui::GetStyle().ItemSpacing.y * 2.0f);
        ...
        case Stage::Input:
            ...
            dnf_composer::user_interface::widgets::Spring(1, 0);
            dnf_composer::user_interface::widgets::EndVertical();
    ...
    {
        case Stage::Begin:
            dnf_composer::user_interface::widgets::BeginVertical("node");
            break;

        case Stage::Header:
            HasHeader = true;

            dnf_composer::user_interface::widgets::BeginHorizontal("header");
            break;
        ...
        case Stage::Content:
            ...
            dnf_composer::user_interface::widgets::BeginHorizontal("content");
            dnf_composer::user_interface::widgets::Spring(0, 0);
            break;

        case Stage::Input:
            dnf_composer::user_interface::widgets::BeginVertical("inputs", 0.0f);
        ...
        case Stage::Middle:
            dnf_composer::user_interface::widgets::Spring(1);
            dnf_composer::user_interface::widgets::BeginVertical("middle", 1.0f);
            break;
        ...
        case Stage::Output:
            if (oldStage == Stage::Middle || oldStage == Stage::Input)
                ...
                dnf_composer::user_interface::widgets::Spring(1, 0);
            dnf_composer::user_interface::widgets::BeginVertical("outputs", 1.0f);
