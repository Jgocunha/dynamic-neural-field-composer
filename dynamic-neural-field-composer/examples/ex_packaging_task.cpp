...
//
// Loads a pre-evolved DFT control architecture for a packaging task from a
// JSON file (generated by a neuro-evolutionary optimizer). The architecture
// encodes spatial location fields for small objects, large objects, and hand
// position, plus hidden and output fields that coordinate the pick-and-place
// sequence.
//
// This example demonstrates loading a simulation from disk rather than
// constructing it manually in code, making it useful for inspecting and
// analyzing evolved or pre-designed architectures.
