...
namespace dnf_composer::element
{
	...
	private:
		...
		// every other 2D convolution element (see MexicanHatKernel2D). Note
		// kernel_1d_x/y here are NOT palindromic (gauss + timeShift*derivative),
		// which is what makes this element the one that can detect a reversed
		// wrap-embedding sign convention (see embedWrapped1D in tools/math.h).
		bool useFFT_ = false;
