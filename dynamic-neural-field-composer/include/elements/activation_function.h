...
namespace dnf_composer::element
{
	...
	enum ActivationFunctionType : int
	{
		...
		ABSSIGMOID,  ///< Rational (absolute-value) sigmoid approximation.
	};
	...
	{
		double x_shift;   ///< Inflection point of the sigmoid (threshold).
	...
	/// @brief Rational (absolute-value) sigmoid.
	///
	...
	{
		double x_shift; ///< Inflection point / threshold.
		double beta;    ///< Steepness parameter.
